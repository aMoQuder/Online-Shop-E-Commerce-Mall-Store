        ...
        <div class="page-content">
            <div class="cart">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9">
                            @if ($message = Session::get('massege'))
                                <div class="row">

                                    <div class="col-12">

                                        <div class="p-4 mb-3 alert alert-success text-center rounded">
                            ...
                            <table class="table table-cart table-mobile">
                                ...
                                @endforeach
                                        ...
                                        <h2 class="alert alert-danger text-center px-3 mb-5"> The Cart Is Empty </h2>
                                    @endif
                            ...
                            <div class="cart-bottom">
                                ...
                                <form action="{{ route('cart.update') }}" class="ml-2" method="POST">
                                    @csrf
                                    {{-- <input type="hidden" value="{{ $item->id }}" name="id"> --}}
                        ...
                        <aside class="col-lg-3">
                            <div class="summary summary-cart">
                                ...
                                <form action="{{ route('checkoutorder') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <form action="{{ route('checkoutorder') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <button type="submit" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE
                                            SHOPPING</span><i class="icon-refresh"></i></button>
                            </form>
                        </aside><!-- End .col-lg-3 -->
                    </div><!-- End .row -->
                </div><!-- End .container -->
