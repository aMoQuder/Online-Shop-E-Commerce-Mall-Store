        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="contact-info">
                                ...
                                <ul class="contact-list">
                                    <li>
                                        <i class="icon-map-marker"></i> 70 Washington Square South New York, NY 10012, United States
                                    </li>
                                    <li>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="contact-form mb-3" action="{{route('contactSave')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
