        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 col-md-9 col-sm-9 col-xs-12">
                    @if (session('massege'))
                    <h3 class="alert alert-alert-primary text-center" style="margin-bottom: 10px;">{{ session('massege') }} </h3>
            @endif
                    ...
                    <div class="hpanel responsive-mg-b-30">
                        <div class="panel-body">
                            <form class="mail-compose" action="{{ route('storeProduct') }}" method="post"
                                ...
                                <div class="row px-3">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input class="form-control" style="margin-bottom:7px;" type="text" placeholder="name" name="name">
                                        @error('name')
                                            <div class="alert alert-danger my-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <input class="form-control" style="margin-bottom:7px;" type="text" placeholder="price" name="price">
                                        @error('price')
                                            <div class="alert alert-danger my-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row px-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" style="margin-bottom:7px;" name="parent_id">



                                            @foreach ($category as $cat)
                                                <option style="color: #2aa6df" value="{{ $cat->id }}">
                                                    {{ $cat->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group  col-12 mt-5">
                                    ...
                                    <div style="margin-bottom:7px;">
                                        <textarea class="form-control" name="description" placeholder="Enter Description" rows="7"> </textarea>
                                    </div>
                                    @error('description')
                                        <div class="alert alert-danger my-2">{{ $message }}</div>
                                    @enderror
                            ...
                            @enderror
                                            ...
                                            <img src="#"class="w-100 "  id="image_preview"   style="height: 250px; margin: auto; margin-top:10px; margin-bottom:10px;" alt="">
